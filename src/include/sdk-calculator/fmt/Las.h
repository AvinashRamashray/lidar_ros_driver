...
#include <sdk-calculator/fmt/Point.h>
...
protected:
    ...
    std::size_t encodePointFormat0(buffer_writer& buffer, const Point_LAS& point);
    std::size_t encodePointFormat1(buffer_writer& buffer, const Point_LAS& point);
    std::size_t encodePointFormat2(buffer_writer& buffer, const Point_LAS& point);
    std::size_t encodePointFormat3(buffer_writer& buffer, const Point_LAS& point);
    std::size_t encodePointFormat4(buffer_writer& buffer, const Point_LAS& point);
