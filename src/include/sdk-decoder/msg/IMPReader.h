...
#include <sdk-decoder/msg/Reader.h>
#include <sdk-decoder/msg/DeDebug.h>
...
private:
    ...
    Configure               _metadata;
	//static std::vector< uint32_t>         sychronTemp_s;
	//static uint32_t        sychronTemp_s_idx;
	//static std::vector< uint32_t>         sychronTemp_us;

	static  uint32_t        sychronTemp_s;
	static  uint32_t       sychronTemp_us;
