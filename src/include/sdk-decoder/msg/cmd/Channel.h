...
#include <sdk-decoder/Stream.h>

#include <sdk-decoder/utils/bytes_order.h>
#include <sdk-decoder/utils/circular_buffer.h>
#include <sdk-decoder/utils/buffer_writer.h>
#include <sdk-decoder/utils/buffer_reader.h>

#include <sdk-decoder/utils/buffer.h>
#include <sdk-decoder/utils/mutex.h>
#include <sdk-decoder/utils/thread.h>
#include <sdk-decoder/utils/condition_variable.h>
...
//        std::swap(_stream_mutex, other._stream_mutex);
    ...
    packet_type read()
    {
        ...
        while (!this->closed()) {
			...
			{
				//CMD_ERR
				packet.head().set_flags(packet.CMD_ERR);
				_buffer.clear();
				return packet;
			}
           // underflow();
...
protected:
	void underflow()
	{
		...
		while (recv_flag)
		{
			...
			if (len == 0 || _read_swap[0] == 0xffffffaa)
			{
				recv_flag = false;
			}
		}   
