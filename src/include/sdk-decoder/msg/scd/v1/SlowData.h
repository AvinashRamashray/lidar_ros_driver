...
#include <sdk-decoder/msg/Message.h>
#include <sdk-decoder/msg/scd/SCDMessage.h>
#include <sdk-decoder/msg/scd/SCDSlowData.h>
...
typedef struct
{
	uint32_t syncWord;//0xE8E8E8E8
	uint32_t ppsStamp;
	uint32_t ppsCount;
}SCD_SYNC_PPS;//2020/07/25
...
class SynchronPPS : public scd::Message<SCD_SYNC_PPS>,
	public scd::SynchronMessagePPS {
public:
	inline uint64_t dataId() const override
	{
		return this->data().syncWord;
